...
import iconSvg2_2 from "../../image/mobile/Ellipse 103.svg"
...
const DownloadMaterials = () => {
    return (
        <div className="downloadMaterials pb-5 pt-4">
            ...
            {/*        <div className="left d-inline-block m-2">*/}
            ...
            {/*            </div>*/}
            {/*        </div>*/}
            {/*        <div className="right d-inline-block m-2">*/}
            {/*            <div className="col-5 col-md-5 d-flex  ">*/}
            {/*                <img className="photoElement d-none d-sm-block " src={iconSvg2} alt=""/>*/}
            {/*                <img className="photoElement d-md-none " src={iconSvg2_2} alt=""/>*/}
            {/*            </div>*/}
            ...
            <div className="containerIndex">
                ...
                <div className=" divContainer">
                    ...
                    <div className="right d-flex m-2">
                        <div className="col-5 col-md-5 d-flex  ">
                            <img className="photoElement d-none d-sm-block " src={iconSvg2} alt=""/>
                            <img className="img-fluid photoElement d-md-none " src={iconSvg2_2} alt=""/>
                        </div>
                        <div className="col-5 divMd m-3">
                            <h4>Скачайте полный каталог продукции ГСК</h4>
                            <button className="btn btnWar">Скачать каталог</button>
